...
class Tests {
    ...
    fun flattenPhoneNumber() {
        ...
        assertEquals("", flattenPhoneNumber("+ ((921У) 123-45-67Я"))
        assertEquals("", flattenPhoneNumber("+7 (921)))+66 123-45-67"))
    }
    ...
    fun bestLongJump() {
        ...
        assertEquals(-1, bestLongJump("-790- - 22 % 717 % 703"))
        assertEquals(777, bestLongJump("777"))
    }
    ...
    fun bestHighJump() {
        ...
        assertEquals(-1, bestHighJump("7% +"))
        assertEquals(-1, bestHighJump("6+6 11+55%"))
    }
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Л 55Л 44"))
    }
